    ...
    <Tooltip>
      <TooltipTrigger asChild>
        <button
          ...
          } hover:scale-110 active:scale-90 transition-transform flex items-center justify-center cursor-pointer bg-transparent text-foreground p-0 border-0 filter-[drop-shadow(0_0_1px_rgba(255,255,255,0.8))_drop-shadow(0_1px_1px_rgba(0,0,0,0.3))] ${className}`}
          aria-label="Ask AI"
