# Astro + React Example with Peam

This is a simple Astro + React example application demonstrating how to use Peam for AI-powered search and chat.
...
The `peam` CLI will automatically extract and index your content during the build.
