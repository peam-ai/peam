...
export const metadata: Metadata = {
  title: 'About Us - Next.js 16 Example',
  description: 'Learn more about our Next.js 16 example application',
};
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-md p-8 mb-6">
            ...
            <p className="text-gray-600 leading-relaxed">
              This example showcases the latest features of Next.js 16, combined
              with the beautiful styling capabilities of Tailwind CSS, all integrated
              with Peam's powerful functionality.
            </p>
          </div>
