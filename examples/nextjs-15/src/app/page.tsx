      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            This is a Next.js 15 example application demonstrating Peam integration.
          </p>
          <div className="bg-white rounded-lg shadow-md p-8 mb-8">
            ...
            <p className="text-gray-600 leading-relaxed">
              Explore this simple example to see how Peam works with Next.js 15.
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <p className="text-gray-600 text-sm">Built with the latest Next.js 15</p>
            </div>
            <div className="bg-white rounded-lg shadow-md p-6">
