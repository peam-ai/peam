# Next.js 14 Example with Peam

This is a simple Next.js 14 example application demonstrating how to use Peam for AI-powered search and chat.
...
The `postbuild` script will automatically run `peam` to index your content.
