  ...
  <section className="px-8 sm:px-4 py-12 sm:py-16">
    <div className="max-w-3xl mx-auto space-y-6">
      <div className="text-center space-y-3">
        <h2 className="font-semibold text-2xl sm:text-3xl lg:text-4xl tracking-tight">Semantic Search</h2>
        ...
        <div className="p-4 rounded-lg border">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Optimized vector search delivers results in milliseconds</p>
            </div>
          </div>
        </div>
        <div className="p-4 rounded-lg border">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Ranks content by semantic similarity for accurate answers</p>
            </div>
          </div>
        </div>
      </div>
