...
Wraps your Next.js config to enable Peam content extraction during build. It sets configuration for the adapter, search store, and output file tracing.
...
Controls robots.txt filtering. If `false`, robots filtering is disabled.
...
- For Next.js 14, use the postbuild CLI approach (see [Next.js guide](/docs/next))
...
- [Next.js guide](/docs/next)
- [createChat](/docs/api-reference/server/create-chat)
